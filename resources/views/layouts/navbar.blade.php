<nav class="bg-white border-gray-200 dark:bg-gradient-to-tr from-gray-900 to-gray-800">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="{{ ! Route::is('home') ? route('home') : 'javascript:void(0)' }}" class="flex items-center space-x-3 rtl:space-x-reverse">
